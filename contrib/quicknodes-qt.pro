...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/quicknodes-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/quicknodes-cli.cpp \
           src/quicknodes-tx.cpp \
           src/quicknodes.cpp \
           src/db.cpp \
           ...
           src/qt/quicknodes.cpp \
           src/qt/quicknodesstrings.cpp \
...
RESOURCES += src/qt/quicknodes.qrc src/qt/quicknodes_locale.qrc

TRANSLATIONS += src/qt/locale/quicknodes_bg.ts \
                src/qt/locale/quicknodes_de.ts \
                src/qt/locale/quicknodes_en.ts \
                src/qt/locale/quicknodes_es.ts \
                src/qt/locale/quicknodes_fi.ts \
                src/qt/locale/quicknodes_fr.ts \
                src/qt/locale/quicknodes_it.ts \
                src/qt/locale/quicknodes_ja.ts \
                src/qt/locale/quicknodes_pl.ts \
                src/qt/locale/quicknodes_pt.ts \
                src/qt/locale/quicknodes_ru.ts \
                src/qt/locale/quicknodes_sk.ts \
                src/qt/locale/quicknodes_sv.ts \
                src/qt/locale/quicknodes_vi.ts \
                src/qt/locale/quicknodes_zh_CN.ts \
                src/qt/locale/quicknodes_zh_TW.ts
