Contributing to quicknodes Core
============================

The quicknodes Core project operates an open contributor model where anyone is
...
The following applies to code changes to the quicknodes Core project, and is not to be
confused with overall quicknodes Network Protocol consensus changes.

Whether a pull request is merged into quicknodes Core rests with the project merge
...
Patches that change quicknodes consensus rules are considerably more involved than
...
Where a patch set proposes to change the quicknodes consensus, it must have been
...
The project leader is the release manager for each quicknodes Core release.
