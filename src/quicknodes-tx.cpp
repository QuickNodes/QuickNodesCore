...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("quicknodes Core quicknodes-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  quicknodes-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quicknodes transaction") + "\n" +
                               "  quicknodes-tx [options] -create [commands]   " + _("Create hex-encoded quicknodes transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded quicknodes transaction
