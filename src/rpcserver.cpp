...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop quicknodes server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "quicknodes server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* quicknodes features */
        {"quicknodes", "masternode", &masternode, true, true, false},
        {"quicknodes", "listmasternodes", &listmasternodes, true, true, false},
        {"quicknodes", "getmasternodecount", &getmasternodecount, true, true, false},
        {"quicknodes", "masternodeconnect", &masternodeconnect, true, true, false},
        {"quicknodes", "masternodecurrent", &masternodecurrent, true, true, false},
        {"quicknodes", "masternodedebug", &masternodedebug, true, true, false},
        {"quicknodes", "startmasternode", &startmasternode, true, true, false},
        {"quicknodes", "createmasternodekey", &createmasternodekey, true, true, false},
        {"quicknodes", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"quicknodes", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"quicknodes", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"quicknodes", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"quicknodes", "getmasternodescores", &getmasternodescores, true, true, false},
        {"quicknodes", "mnbudget", &mnbudget, true, true, false},
        {"quicknodes", "preparebudget", &preparebudget, true, true, false},
        {"quicknodes", "submitbudget", &submitbudget, true, true, false},
        {"quicknodes", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"quicknodes", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"quicknodes", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"quicknodes", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"quicknodes", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"quicknodes", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"quicknodes", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"quicknodes", "checkbudgets", &checkbudgets, true, true, false},
        {"quicknodes", "mnsync", &mnsync, true, true, false},
        {"quicknodes", "spork", &spork, true, true, false},
        {"quicknodes", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"quicknodes", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use quicknodesd, or the -server option to quicknodes-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> quicknodes-cli " + methodname + " " + args + "\n";
}
