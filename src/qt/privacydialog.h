...
public:
    ...
    void setZquicknodesControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzqns_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzqns_clicked();
    void on_pushButtonZquicknodesControl_clicked();
