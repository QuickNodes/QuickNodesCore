                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("quicknodes Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a quicknodes address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quicknodes: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zqns"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About quicknodes Core"), this);
    aboutAction->setStatusTip(tr("Show information about quicknodes Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for quicknodes"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your quicknodes addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified quicknodes addresses"));
    ...
    openAction->setStatusTip(tr("Open a quicknodes: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the quicknodes Core help message to get a list with possible quicknodes command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("quicknodes Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to quicknodes network", "", count));
}
...
{
    QString strTitle = tr("quicknodes Core"); // default title
...
/** Creates context menu, its actions, and quicknodess up all the relevant signals for mouse events. */
