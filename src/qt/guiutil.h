...
/** Utility functions used by the quicknodes Qt UI.
 */
namespace GUIUtil
{
...
// Render quicknodes addresses in monospace font
...
// Parse "quicknodes:" URI into recipient object, return true on successful parsing
