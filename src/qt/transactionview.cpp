                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received quicknodes from zqns"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zqns"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zqns));
