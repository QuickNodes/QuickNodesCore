...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("quicknodes Core"),
     ...
     * override -datadir in the quicknodes.conf file in the default data directory
     * (to be consistent with quicknodesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
