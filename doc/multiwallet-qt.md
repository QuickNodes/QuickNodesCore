...
In order to support loading of multiple wallets in quicknodes-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is quicknodes.cpp.
...
Changes to quicknodes.cpp
----------------------
quicknodes.cpp is the entry point into quicknodes-qt, and as such, will require some minor modifications to provide hooks for
